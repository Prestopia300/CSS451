...
public class SceneNode : MonoBehaviour {
    ...
    public void CompositeXform(ref Matrix4x4 parentXform)
    {
        ...
        kDefaultTreeTip = new Vector3(0f, 0f, 0f); // mCombinedParentXform.GetColumn(3); gives me strange values, and changes when it is moved
        // This is transform away from the origin, so if this is set to the position, then the location of the axis frame becomes : pos + pos.
